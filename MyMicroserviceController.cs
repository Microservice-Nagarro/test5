using BHF.MS.test5.Models;
using BHF.MS.test5.Services;
using Microsoft.AspNetCore.Mvc;

namespace BHF.MS.test5.Controllers
{
    [ApiController]
    [Route("[controller]")]
    public class test5Controller(ILogger<test5Controller> logger, IExampleService service) : ControllerBase
    {
        [HttpGet]
